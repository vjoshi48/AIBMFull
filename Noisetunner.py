...
logdir = "../logs/.../"
checkpoint = utils.load_checkpoint("/data/users2/vjoshi6/bin/pythonFiles/AIBM/final/bmenet_gmve/train.100.pth")
...
samples = 20
best_region_index = 38
#TODO: CHANGE BACK TO 4 AND CHANGE 38 back to i
...
for i in range(0, 1):
    ...
    print('Calculating the initial integrated gradients...')
    ...
    print('Calculating the noisetunnelling...')
    ...
    plt.colorbar(c)
    plt.title(names[i])
    plt.savefig(names[i] + '/' + names[i] + str(samples) + 'imshowmethod_transversal_both_nt.png')
    plt.clf()
    plt.imshow(transversal_ig, cmap='hot')
    plt.colorbar()
    plt.title(names[i])
    plt.savefig(names[i] + '/' + names[i] + str(samples) + 'imshowmethod_transversal_ig_nt.png')
    plt.clf()
    ...
    plt.colorbar(c)
    plt.title(names[i])
    plt.savefig(names[i] + '/' + names[i] + str(samples) + 'imshowmethod_coronal_both_nt.png')
    plt.clf()
    plt.imshow(coronal_ig, cmap='hot')
    plt.colorbar()
    plt.title(names[i])
    plt.savefig(names[i] + '/' + names[i] + str(samples) + 'imshowmethod_coronal_ig_nt.png')
    plt.clf()
    ...
    plt.colorbar(c)
    plt.title(names[i])
    plt.savefig(names[i] + '/' + names[i] + str(samples) + 'imshowmethod_sagittal_both_nt.png')
    plt.clf()
    plt.imshow(sagittal_ig, cmap='hot')
    plt.colorbar()
    plt.title(names[i])
    plt.savefig(names[i] + '/' + names[i] + str(samples) + 'imshowmethod_sagittal_ig_nt.png')
    plt.clf()
    ...
    plt.title(names[i])
    plt.savefig(names[i] + '/' + names[i] + str(samples) + "Original_viz_nt.png")
    plt.clf()
