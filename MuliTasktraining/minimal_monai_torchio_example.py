...
#NOTE: Copy this into minimal example
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--logdir",
        metavar="PATH",
        default="/data/users2/kwang26/meshnet_results/",
        help="Path to list with brains for validation",
    )
    ...
    logdir = "{log_dir}/{model}_{filters}_filters_gmwm_sv_{sv}_full_train".format(
        log_dir=args.logdir, model=args.model, filters=args.n_filters, sv=args.sv_w)
